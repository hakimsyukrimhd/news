    ...
    const news = [
      {
        ...
        userId: 1,
        categoryId: 1,
        slug: "nusron-tindak-kepala-seksi-pengukuran-terkait-shgb-pagar-laut-tangerang",
        createdAt: new Date(),
        updatedAt: new Date(),
      ...
      },
      {
        ...
        userId: 1,
        categoryId: 1,
        slug: "profil-widiyanti-putri-wardhana-menteri-pariwisata-yang-punya-harta-rp-54-t",
        createdAt: new Date(),
        updatedAt: new Date(),
      },
      {
        ...
        userId: 1,
        categoryId: 1,
        slug: "prabowo-menjanjikan-indonesia-emas-2045",
        createdAt: new Date(),
        updatedAt: new Date(),
      },
    ];
